...
$namePage = "Профиль путешественника";
...
?>
    <div class="container content traveller-profile">
        <div class="row">
                ...
                <div class="row btn-block">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="search-filter">
                            <a href="<?=SITE_DIR?>traveller-profile.php" class="btn btn-9 active">Профиль</a>
                ...
                <form action="" method="post" role="form">
                    <div class="row profile-top">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-center foto">
                            ...
                            <button type="button" name="fileImg" accept="image/jpeg,image/png" class="btn btn-2">Заменить фото</button>
                        </div>
