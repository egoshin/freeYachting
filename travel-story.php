                ...
                <div class="row btn-block">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="search-filter">
                            ...
                            <a href="<?=SITE_DIR?>travel-story.php" class="btn btn-9 active">История путешествий</a>
                            <a href="<?=SITE_DIR?>travel-booked.php" class="btn btn-9">Забронированные путешествия</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="row">
                                    	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 btn-story-more">
                                            <a href="<?=SITE_DIR?>yachta-history.php" class="btn btn-3">Подробнее</a>
                                    	</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="media-left visible-xs" href="#">
                                        <img src="/images/img04.jpg" alt="Маршруты из точки A в точку B" class="img-responsive">
                                    </a>
                                    <div class="row property-story-top">
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <p>Рейтинг капитана: <b>5</b></p>
