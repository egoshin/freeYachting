<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="#tab1" role="tab" data-toggle="tab">Карта путешествий</a></li>
    <div class="clearfix visible-xs"></div>
    <li><a href="#tab2" role="tab" data-toggle="tab">Отзывы о путешествии</a></li>
    <div class="clearfix visible-xs"></div>
    <li><a href="#tab3" role="tab" data-toggle="tab">Особенности</a></li>
</ul>
<div class="tab-content">
    <div class="active tab-pane fade in" id="tab1">
        <img src="<?=SITE_DIR?>images/map-putesh.jpg" alt="Карта путешествий" class="img-responsive">
    </div>
    <div class="tab-pane fade" id="tab2">
        ...
        <ul class="pagination2 visible-sm visible-xs text-center list-unstyled list-inline">
            <li><a href="#"></a></li>
    ...
    <div class="tab-pane fade" id="tab3">
        ...
        <div class="column2">
            <p>
                ...
                (марина MarinaSolila) и оснащена всем необходимым для обслуживания яхт. Аренда катамарана в
                Черногории позволит вам свободно перемещаться по всей акватории, обойти все острова и
                заливы, насладиться уединенными гаванями и пляжами, а также получить удовольствие от морских
                развлечений, как рыбалка, снорклинг и др. – все это включено в круизную программу.
            </p>
            <p>
                Аренда катамарана в Черногории позволит вам свободно перемещаться по всей акватории, обойти
                все острова и заливы, насладиться уединенными гаванями и пляжами, а также получить
